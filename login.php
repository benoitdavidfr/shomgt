...
doc: |
  ...
  Pour se loguer au site, il faut un compte défini dans lib/secretconfig.inc.php
...
class Login {
  ...
  static function loginUsingPost() { // Cas d'utilisation no 1 : appel du script par un utilisateur non logué
    // 3 cas d'appels:
